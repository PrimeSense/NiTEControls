...
*/
class XNV_NITE_CONTROLS_API XnVMultipleHands
{
public:
	/**
	...
	*/
	 ...
	 */
	class XNV_NITE_CONTROLS_API ConstIterator
	{
	public:
	...
	*/
	class XNV_NITE_CONTROLS_API Iterator : public ConstIterator
	{
	public:
		friend class XnVMultipleHands;
	...
	class XNV_NITE_CONTROLS_API ConstIteratorOld
	{
	public:
		friend class XnVMultipleHands;
	...
	*/
	class XNV_NITE_CONTROLS_API IteratorOld : public ConstIteratorOld
	{
	public:
		friend class XnVMultipleHands;
